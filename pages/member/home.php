...
?>
    ...
    <div class="Content-center-Stats">
        <div class="row stats">
            <div class="column-3">
                <div class="container-column-3">
                    <h2>365 <br><br>Days of Work</h2>
                </div>

            </div>
            <div class="column-3">
                <div class="container-column-3">
                    <h2>5 - 7 <br><br> Days of Week</h2>
                </div>
            </div>
            <div class="column-3">
                <div class="container-column-3">
                    <h2>15+ <br><br> Expert Trainers</h2>
                </div>
            </div>
        </div>
    </div>
    <div class="expert-training-1">
        <div class="row">
            <div class="column">
